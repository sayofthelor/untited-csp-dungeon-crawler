...
// Pretty much entirely from the flixel demo as of now, i will overhaul it later
...
class Combat extends FlxTypedGroup<FlxSprite>
{
	...
	public var enemy:EnemyController; // we will pass the enemySprite that the playerSprite touched to initialize combat, and this will let us also know which enemySprite to kill, etc.
	...
	var playerSprite:PlayerController; // this is a sprite of the playerSprite
	var enemySprite:EnemyController; // this is a sprite of the enemySprite
	 ...
	 */
	public function initCombat(playerHealth:Int, enemy:EnemyController)
	{
		screen.drawFrame();
